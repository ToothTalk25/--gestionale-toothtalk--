...
export const INFORMATIVA_PRIVACY: Blocco[] = [
  ...
  p("Il Titolare del trattamento è Enrico Maria Guarino, in qualità di titolare del progetto editoriale “Tooth Talk™”, C.F. GRNNCM05H20C342W. E-mail: tooth.talk25@gmail.com. PEC: toothtalk@pec.it."),
  ...
  p("Per esercitarli, scrivi a tooth.talk25@gmail.com o, per la certificazione di consegna, alla PEC toothtalk@pec.it."),
