...
export const INFORMATIVA_PRIVACY: Blocco[] = [
  ...
  p("Il Titolare del trattamento è Enrico Maria Guarino, in qualità di titolare del progetto editoriale “Tooth Talk™”, C.F. GRNNCM05H20C342W. E-mail: tooth.talk25@gmail.com. PEC: enricomariaguarino@postecertifica.it."),
  ...
  p("Per esercitarli, scrivi a tooth.talk25@gmail.com o, per la certificazione di consegna, alla PEC enricomariaguarino@postecertifica.it."),
  ...
  p("Revoca del consenso: sempre possibile in qualsiasi momento, senza obbligo di indicarne il motivo, tramite l'apposita funzione di revoca nel proprio profilo del gestionale (che costituisce comunicazione scritta a tutti gli effetti) oppure scrivendo a tooth.talk25@gmail.com o alla PEC enricomariaguarino@postecertifica.it — non pregiudica la liceità del trattamento basata sul consenso prima della revoca. La revoca comporta l'individuazione e la cancellazione, da parte del Coordinatore, del materiale grezzo non pubblicato che ti ritrae, entro 30 (trenta) giorni dalla revoca — non è una cancellazione automatica: il sistema registra chi ha caricato un file, non chi vi compare, quindi la verifica di quali file eliminare è sempre umana; non comporta invece, di per sé, la rimozione dei contenuti già pubblicati: questi restano online anche sulla base del legittimo interesse del Progetto a mantenerli accessibili (vedi sopra), fermo restando il diritto di opporsi in qualsiasi momento ai sensi dell'art. 21 GDPR. Richieste di rimozione o opposizione relative a un contenuto già pubblicato sono valutate caso per caso, bilanciando il legittimo interesse del Progetto con quello dell'interessato e le eccezioni di cui all'art. 17, par. 3, GDPR (libertà di espressione e informazione), con risposta entro 30 (trenta) giorni, prorogabile a 90 (novanta) giorni con motivazione scritta."),
