...
export const INFORMATIVA_PRIVACY: Blocco[] = [
  ...
  p("I documenti di consenso firmati (accordo editoriale, liberatoria, video di dichiarazione di identità) sono conservati per un periodo di 10 (dieci) anni dalla cessazione della collaborazione, a tutela legale del Progetto (art. 17, par. 3, lett. e) GDPR; prescrizione ordinaria, art. 2946 c.c.)."),
