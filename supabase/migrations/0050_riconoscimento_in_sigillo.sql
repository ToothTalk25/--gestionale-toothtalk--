-- =====================================================================
-- 0050_riconoscimento_in_sigillo.sql
-- Aggiunge il controllo di riconoscimento automatico (Fase D) al flusso
-- di sigillo del pacchetto.
-- =====================================================================
...
begin
  ...
  -- Fase D: controllo riconoscimento automatico
