-- =====================================================================
-- 0127_elimina_progetto_consensi.sql
-- =====================================================================
-- Secondo anello mancante di elimina_progetto: le registrazioni di
-- consenso (consents_and_releases) referenziano le richieste di
-- liberatoria, che a loro volta referenziano le versioni. L ordine di
-- cancellazione va quindi completato partendo dal fondo: consensi,
-- richieste, versioni.
--
-- Nota: le righe di consenso di un progetto se ne vanno comunque con lui
-- (vincolo on delete cascade dal progetto): qui si anticipa soltanto
-- l operazione, perché la chiave esterna sulle richieste impedisce di
-- arrivarci per cascata.
-- =====================================================================
