-- =====================================================================
-- 0065_sigillo_richiede_numero_video.sql
-- Senza numero_video l'esportazione su Drive nomina cartelle/file "Video ? -
-- Titolo": inservibile per l'archiviazione. Si blocca il sigillo finché
-- l'admin non ha assegnato il numero.
-- =====================================================================
