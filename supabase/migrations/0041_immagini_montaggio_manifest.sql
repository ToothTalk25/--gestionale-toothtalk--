-- =====================================================================
-- 0041_immagini_montaggio_manifest.sql — solo impronta nel manifesto
-- =====================================================================
-- Estende sigilla_pacchetto (0034) per includere nel manifesto le
-- "Immagini montaggio video" caricate per il task. Entrano solo come
-- impronta SHA256 + metadati, non vengono allegate alla PEC.
-- =====================================================================
