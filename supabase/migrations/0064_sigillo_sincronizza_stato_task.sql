-- =====================================================================
-- 0064_sigillo_sincronizza_stato_task.sql
-- Al sigillo, lo stato del progetto (tasks.status, l'etichetta manuale in
-- cima alla pagina) passa da solo a 'sigillato' — il gruppo lo vede senza
-- che nessuno debba ricordarsi di cliccarlo a mano.
-- =====================================================================
