-- =====================================================================
-- 0126_elimina_progetto_liberatorie.sql
-- =====================================================================
-- elimina_progetto (0036) cancellava versioni e pacchetto ma non le
-- richieste di liberatoria: il vincolo di chiave esterna
-- (richieste_liberatoria.version_id -> deliverable_versions) bloccava la
-- cancellazione di ogni progetto con una liberatoria in corso o caricata.
-- La richiesta appartiene al progetto: si toglie insieme a lui.
-- Restano intatte le due protezioni vere: un progetto bloccato e un
-- pacchetto certificato via PEC non si eliminano.
-- =====================================================================
