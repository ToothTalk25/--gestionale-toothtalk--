-- =====================================================================
-- 0104_sigillo_blocca_revoca_consenso.sql — non si sigilla chi ha revocato
-- =====================================================================
-- Accordo Art. 8.2/8.3: se un partecipante del pacchetto ha revocato il
-- consenso a immagine/voce (o ha una richiesta di rimozione del pubblicato
-- APERTA), il pacchetto non va sigillato/certificato via PEC: il sigillo
-- darebbe valore probatorio a un contenuto che ritrae chi ha chiesto di
-- non esserci. Il controllo guarda i version_id del pacchetto e risale a
-- chi li ha caricati (uploaded_by), quindi a consensi/richieste.
-- =====================================================================
