-- =====================================================================
-- 0052_liberatoria_solo_otp.sql
-- Restringe il sigillo: la liberatoria deve essere firmata via OTP
-- (email con codice a 6 cifre), non basta un upload manuale o canvas.
-- =====================================================================
